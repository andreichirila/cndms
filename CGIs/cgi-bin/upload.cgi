...
#	$dbh->prepare("INSERT INTO CameronetDokVer.Dokumente (LocationID,BID,Version,AutorID,type,Beschreibung,Created_at,Pfad,Name) VALUES (?,?,?,?,?,?,?,?,?);");
							
	$newInsert->execute($locationId_,4,$docVersion_,$autorId_,"file",$docComments_,$docDate_,"/folders/$fileName_",$fileName_) or die $newInsert->err_str;
#	}else{
